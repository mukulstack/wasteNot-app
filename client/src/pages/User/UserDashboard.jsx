			...
			<div className="p-6 space-y-10 bg-[#282828] text-[#ebdbb2] min-h-screen">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div className="bg-[#3c3836] rounded-xl shadow-md p-6">
						<h5 className="text-lg font-semibold text-[#ebdbb2] mb-4">Task Distribution</h5>
						<CustomPieChart data={pieChartData} colors={COLORS} />
					</div>

					<div className="bg-[#3c3836] rounded-xl shadow-md p-6">
						<h5 className="text-lg font-semibold text-[#ebdbb2] mb-4">Task Priority Levels</h5>
				...
				<div className="bg-[#3c3836] rounded-xl shadow-md p-6">
					<div className="flex justify-between items-center mb-4">
						<h5 className="text-lg font-semibold text-[#ebdbb2]">Recent Tasks</h5>
						<button
							onClick={onSeeMore}
